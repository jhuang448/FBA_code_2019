...
function evaluatePerformancePitchedInstrument2_1(read_file_name1, read_file_name2, test_file_name, flag, ifpYin)
...
train_features = train_features(:, [1:28]);
test_features = test_features(:, [1:28]);
